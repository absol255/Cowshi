import { formatCents } from "@/lib/cowshi/format";
import type { BookLevel } from "@/lib/cowshi/types";
      ...
      <div className="space-y-1">
        {levels.map((level) => (
          <div key={`${title}-${level.price_cents}`} className="relative overflow-hidden rounded-md">
            ...
            />
            <div className="relative flex justify-between px-2 py-1 font-mono tabular-nums">
