            ...
            {positions.map((p) => (
              ...
              >
                ...
                <div className="text-sm">
                  <span className="mr-4 text-yes-text">{p.yes_contracts} Yes @ {formatCents(Math.round(p.avg_yes_cents))}</span>
                  <span className="text-no-text">{p.no_contracts} No @ {formatCents(Math.round(p.avg_no_cents))}</span>
                </div>
              </Link>
            ))}
          </div>
